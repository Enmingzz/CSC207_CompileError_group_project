...
/**
 * In-memory implementation of {@link ProductUpdateBuyerScheduleDataAccessInterface} to update the buyer's schedule of a product.
 */
public class InMemoryProductUpdateBuyerScheduleDataAccessObject implements ProductUpdateBuyerScheduleDataAccessInterface {
    ...
    /**
     * Updates the buyer's schedule time of a product by its ID.
     *
     * @param updatedProduct    the product with the new buyer's schedule time
     * @param buyerScheduleTime the new buyer's schedule time
