...
class DatabaseProductReadByUserDataAccessObjectTest {
    ...
    private ProductReadByTagDataAccessInterface databaseProductReadByTagDataAccessObject;
    private ProductReadByUserDataAccessInterface databaseProductReadByUserDataAccessObject;
    ...
    private String studentNumber = "123456789";
    ...
    void setUp() throws SQLException, IOException {
        ...
        databaseProductReadByTagDataAccessObject =
                new DatabaseProductReadByTagDataAccessObject(new CommonProductFactory(), new CommonScheduleFactory());
        databaseProductReadByUserDataAccessObject =
                new DatabaseProductReadByUserDataAccessObject(new CommonProductFactory(),
                        new CommonScheduleFactory());
    }
    ...
    void saveProduct() throws SQLException, IOException {
        ...
        ArrayList<Product> products = databaseProductReadByUserDataAccessObject.getProductByUser(
                studentNumber);
