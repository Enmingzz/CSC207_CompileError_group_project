...
class GetSearchViewOutputDataTest {
    private User user;
    private ArrayList<Product> products;
    private GetSearchViewOutputData getSearchViewOutputData;
    ...
    void setUp() throws IOException {
        ...
        getSearchViewOutputData = new GetSearchViewOutputData(user, products);
    }
    ...
    @Test
    void getUser() {assertEquals(user, getSearchViewOutputData.getUser());
    }

    @Test
    void getAllProducts() {assertEquals(products, getSearchViewOutputData.getAllProducts());
    }
}