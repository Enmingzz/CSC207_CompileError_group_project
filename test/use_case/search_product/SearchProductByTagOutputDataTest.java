...
class SearchProductByTagOutputDataTest {
    private User user;
    private ArrayList<Product> products;
    private SearchProductByTagOutputData searchProductByTagOutputData;
    ...
    void setUp() throws IOException {
        ...
        searchProductByTagOutputData = new SearchProductByTagOutputData(user, products);
    ...
    @Test
    void getProducts() {assertEquals(products, searchProductByTagOutputData.getProducts());
    }

    @Test
    void getUser() {assertEquals(user, searchProductByTagOutputData.getUser());
    }
}