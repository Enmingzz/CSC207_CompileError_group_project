...
class ChangeProductOutputDataTest {
    private User user;
    ...
    void setUp() throws IOException {
        ...
        message = "Only the description failed to update";

        changeProductOutputData = new ChangeProductOutputData(product, message, user);
    }
    ...
    @Test
    void getSeller() {assertEquals(user, changeProductOutputData.getUser());
    }

    @Test
    void getProduct() {assertEquals(product, changeProductOutputData.getProduct());
    }

    @Test
    void getMessage() {assertEquals(message, changeProductOutputData.getMessage())}
